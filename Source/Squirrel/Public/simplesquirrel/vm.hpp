...
namespace ssq {
    ...
    * @ingroup simplesquirrel
    */
    class SQUIRREL_API SSQ_API VM: public Table {
    public:
        FString name_space;
        ...
        */
#ifdef SQUNICODE
        Script compileSource(const FString &source, const FString &name = "buffer");
#else
        ...
        */
#ifdef SQUNICODE
        Script compileFile(const FString &path);
#else
        ...
        */
         ...
         */
#ifdef SQUNICODE
        Enum addEnum(const FString &name);
#else
