...
namespace ssq {
    ...
    namespace detail {
        SQUIRREL_API SSQ_API void addClassObj(HSQUIRRELVM vm, size_t hashCode, const HSQOBJECT& obj);
        SQUIRREL_API SSQ_API const HSQOBJECT& getClassObj(HSQUIRRELVM vm, size_t hashCode);
        ...
        inline bool isType(HSQUIRRELVM vm, SQInteger index, SQObjectType expected){
            auto type = sq_gettype(vm, index);
            if (expected == OT_CLOSURE) {
        ...
        inline double popValue(HSQUIRRELVM vm, SQInteger index){
            if (isType(vm, index, OT_INTEGER)) {
              checkType(vm, index, OT_INTEGER);
              SQInteger val;
              if (SQ_FAILED(sq_getinteger(vm, index, &val))) throw TypeException("Could not get unsigned long long (to double) from squirrel stack");
...
#ifdef SQUNICODE
        template<>
        inline FString popValue(HSQUIRRELVM vm, SQInteger index){
        ...
        SQUIRREL_API SSQ_API void pushRaw(HSQUIRRELVM vm, const Object& value);
        SQUIRREL_API SSQ_API void pushRaw(HSQUIRRELVM vm, const Class& value);
        SQUIRREL_API SSQ_API void pushRaw(HSQUIRRELVM vm, const Instance& value);
        SQUIRREL_API SSQ_API void pushRaw(HSQUIRRELVM vm, const Table& value);
        SQUIRREL_API SSQ_API void pushRaw(HSQUIRRELVM vm, const Function& value);
        SQUIRREL_API SSQ_API void pushRaw(HSQUIRRELVM vm, const Enum& value);
        SQUIRREL_API SSQ_API void pushRaw(HSQUIRRELVM vm, const Array& value);
        SQUIRREL_API SSQ_API void pushRaw(HSQUIRRELVM vm, const SqWeakRef& value);
...
#ifdef SQUNICODE
        template<>
        inline void pushValue(HSQUIRRELVM vm, const FString& value) {
            sq_pushstring(vm, *value, value.Len());
        }
#else
        template<>
