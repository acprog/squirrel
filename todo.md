...
13. переружаемые операторы +=, -= итп
14. одинаковые методы добавления в массив add(value) и +=[]
15. для array методы indexof(value), removeat(index)
16. инициализация значений по умолчанию для полей, унаследованных от C++ класса:
  class A : public NativeA {
    field=10;
  };
