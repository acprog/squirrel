...
13. одинаковые методы добавления в массив add(value) и +=[]
14. для array методы indexof(value), removeat(index)
15. инициализация значений по умолчанию для полей, унаследованных от C++ класса:
